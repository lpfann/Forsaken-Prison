...
public class ChestFactory {
   ...
   public ChestFactory(MainModel main) {
        this.main = main;
            ...
            items.add(new BodyArmor.Lederruestung());
            items.add(new BodyArmor.Eisenruestung());
            items.add(new BodyArmor.Bronzeruestung());
            items.add(new BodyArmor.Silberruestung());
            items.add(new BodyArmor.Goldruestung());
            ...
            items.add(new Shoes.WaldlaeuferSchuhe());
            ...
            items.add(new Shield.VerstaerktesHolzschild());
            items.add(new Shield.Wappenschild());
            items.add(new Shield.VerstaerktesWappenschild());
            items.add(new Shield.RundesEisenschild());
            items.add(new Shield.GehaertetesRundesEisenschild());
